...
def get_first_page():
    url = 'https://realestate.yahoo.co.jp/used/mansion/search/03/13/?geo%5B%5D=13109&geo%5B%5D=13111'
...
def insertDB(content):
    ...
    try:
        cursor.executemany('insert into TwoReg_HPs_link (link) values (%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
